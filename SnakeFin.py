...
def inst():
    ...
    l1 = Label(root3,text="This is a simple and fun snake game!",bg="blue",fg="white")
    l1.pack()
    l2 = Label(root3, text="Use the arrow keys on your keyboard to move up, down left and right",bg="blue",fg="white")
    l2.pack()
    l3 = Label(root3, text="Your score will increase by 10 every time the snake eats food",bg="blue",fg="white")
    l3.pack()
    ...
    l5.pack()
    l6 = Label(root3, text="After the snake dies, you will see 2 options:",bg="blue",fg="white")
    l6.pack()
    l7 = Label(root3, text="Play Again, or Exit the game",bg="blue",fg="white")
    l7.pack()
    l8 = Label(root3, text="If you do not wish to play again, you can view your score in the Output.txt file",bg="blue",fg="white")
    l8.pack()
